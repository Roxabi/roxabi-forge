...
- [ ] Code follows project patterns (see `architecture/patterns.md`)
...
<!-- Add review rules specific to your project. Examples:
  - All HTML template changes need visual verification
  - New gallery templates need README.md update
  - Shared CSS changes need cross-template testing
-->
