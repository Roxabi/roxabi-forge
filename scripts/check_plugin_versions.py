...
Canon: plugins/roxabi-forge/plugin.json  (Agent Plugins root — OMP marketplace).
...
SOURCES: list[tuple[str, Extract]] = [
    ("plugins/roxabi-forge/plugin.json", _plugin_version),
    ("plugins/roxabi-forge/.claude-plugin/plugin.json", _plugin_version),
    ("plugins/roxabi-forge/.grok-plugin/plugin.json", _plugin_version),
    ("plugins/roxabi-forge/.omp-plugin/plugin.json", _plugin_version),
    ("plugins/roxabi-forge/.codex-plugin/plugin.json", _plugin_version),
    ("plugins/roxabi-forge/package.json", _plugin_version),
...
CANON = "plugins/roxabi-forge/plugin.json"
