#!/usr/bin/env bash
# Tag roxabi-forge/vX.Y.Z + GitHub Release when plugins/roxabi-forge/plugin.json is a new SemVer.
# Format <component>/vX.Y.Z (Convention A). History starts at 1.0.0: tags of the
# pre-tree engine stayed with Roxabi/roxabi-forge-legacy.
...
TAG="roxabi-forge/v${VERSION}"
TITLE="roxabi-forge ${TAG#roxabi-forge/}"
