...
#   plugins/roxabi-forge/scripts/gen-og-images.sh --slug my-slug --force
#   plugins/roxabi-forge/scripts/gen-og-images.sh --quality 80
#   plugins/roxabi-forge/scripts/gen-og-images.sh --dry-run
#
