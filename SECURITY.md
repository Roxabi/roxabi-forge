...
1. Use [GitHub private vulnerability reporting](https://github.com/Roxabi/roxabi-forge/security/advisories/new) on this repository, with:
...
- Contents of `~/.config/roxabi/forge/forge.env`
