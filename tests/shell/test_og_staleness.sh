...
mkdir -p "$TD/repo/plugins/roxabi-forge"
cp -a "$ROOT/plugins/roxabi-forge/scripts" "$TD/repo/plugins/roxabi-forge/scripts"
cp -a "$ROOT/plugins/roxabi-forge/forge.config.example.json" \
  "$TD/repo/plugins/roxabi-forge/forge.config.example.json"
GEN="$TD/repo/plugins/roxabi-forge/scripts/gen-og-images.sh"
...
OG_LIB="$TD/repo/plugins/roxabi-forge/scripts/lib"
