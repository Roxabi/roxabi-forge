#!/usr/bin/env python3
"""Mechanical enforcement of the language boundary in plugins/roxabi-forge/scripts/.

The rule
--------
Everything under plugins/roxabi-forge/scripts/ is operator-facing tooling and
...
SCRIPTS = ROOT / "plugins" / "roxabi-forge" / "scripts"
...
ALLOWLIST = frozenset(
    {
        ...
        "hub-index.py",  # writes a Markdown note into the hub vault (French notes)
