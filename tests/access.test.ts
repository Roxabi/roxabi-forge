...
describe("isArtefactRef", () => {
  it("refuses dot-dot anywhere and an empty path segment", () => {
    expect(isArtefactRef("lyra/visuals/architecture.html")).toBe(true)
    expect(isArtefactRef("lyra//visuals/architecture.html")).toBe(false)
    expect(isArtefactRef("lyra/visuals/arch..tecture.html")).toBe(false)
  })
})
